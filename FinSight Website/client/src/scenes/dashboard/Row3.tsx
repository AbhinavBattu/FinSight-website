  ...
  return (
    <>
        ...
        <DashboardBox gridArea="i">
          ...
          <FlexBetween mt="0.4rem" gap="0.5rem" p="0 1rem" textAlign="center">
        ...
        <DashboardBox gridArea="j">
          ...
          >
            ...
            <Typography margin="0.5rem 1rem" variant="h6">
              Q4 marked record user growth, robust revenue increase, strategic partnerships, and successful product launches, solidifying our fintech leadership position.
            </Typography>
          </Box>
        </DashboardBox>
    </>
