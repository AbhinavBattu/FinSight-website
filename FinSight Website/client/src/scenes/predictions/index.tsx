...
import { CartesianGrid, Label, Legend, Line, LineChart, ResponsiveContainer, XAxis, YAxis,Tooltip } from 'recharts';
        ...
        <FlexBetween m="1rem 2.5rem" gap="1rem">
            ...
            <Button 
                ...
                sx={{
                    ...
                    boxShadow:"0.1rem 0.1rem 0.1rem 0.1rem rgba(0,0,.4)"
                }}>
